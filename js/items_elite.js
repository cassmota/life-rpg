...
const ELITE_IMGS = {
  w_broom:      'img/elite/w_broom.png',
  w_firestf:    'img/elite/w_firestf.png',
  w_naturestf:  'img/elite/w_naturestf.png',
  w_bonestf:    'img/elite/w_bonestf.png',
  a_firerobes:  'img/elite/a_firerobes.png',
  a_leafcloak:  'img/elite/a_leafcloak.png',
  a_greencloak: 'img/elite/a_greencloak.png',
  a_ironplate:  'img/elite/a_ironplate.png',
  a_titanplate: 'img/elite/a_titanplate.png',
  a_warlord:    'img/elite/a_warlord.png',
  a_tribaldres: 'img/elite/a_tribaldres.png',
  a_vamcloak:   'img/elite/a_vamcloak.png',
  h_ironhelm:   'img/elite/h_ironhelm.png',
  h_goldhelm:   'img/elite/h_goldhelm.png',
  h_skullcloak: 'img/elite/h_skullcloak.png',
  f_goldenleg:  'img/elite/f_goldenleg.png',
  f_whitelegs:  'img/elite/f_whitelegs.png',
  l_goldskirt:  'img/elite/l_goldskirt.png',
  g_vambrace:   'img/elite/g_vambrace.png',
  g_goldgaunt:  'img/elite/g_goldgaunt.png',
};
